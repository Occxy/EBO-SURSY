...
function addValueInTableReferenceBatCapturees(rowCountContent, rowContent) {
	...
	if ((rowCountContent == 55) && (rowContent != String('')) && (rowContent != String('Manquant'))) {
	...
	if ((rowCountContent == 56) && (rowContent != String('')) && (rowContent != String('Manquant'))) {
...
function addEspeceInTableReferenceBatCapturees(i) {
	...
	function addNewEspeceInTab(Espece) {
		...
		if (new_espece) {			
			...
			tabNewRegimeAlimentaire.push(tab[i][28].trim());
		};
	};	
};
