...
var localDB = new PouchDB(individus_cibu_table + debug);
  	...
  	DB.allDocs({
		...
		if (typeof(JSON.stringify(result)) != "undefined"){  
    		...
    		dataTablesData.rows.forEach(function(row){   
    			table.row.add(new Bat(row.doc.N_identification, row.doc.ID_preleveur, row.doc.Kit_de_prelevement, row.doc.Date_de_prelevement, 
...
function Bat(N_identification, ID_preleveur, Kit_de_prelevement, Date_de_prelevement, Action) {
